 ...
 * {@link org.jasig.cas.client.validation.CAS20ProxyTicketValidator} except that
 * casServerUrlPrefix will be resolved to an IP address on the server at 
 * initialization, not on the client at redirect.
 *
 * @author Scott Battaglia, modifications by R Moulton.
 * @author Brad Cupit (brad [at] lsu {dot} edu)
 * @version $Revision$ $Date$
 * @since 3.1
 *
 */
public class ValFilter extends AbstractTicketValidationFilter implements Serializable {
    ...
    protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
        ...
        final String casServerUrlPrefix = 
        		Util.resolveHost(getPropertyFromInitParams(filterConfig, "casServerUrlPrefix", null));
